...
print(f"мужик {man_gen}")
print(f"женщина {wom_gen}")
...
print(f"kмужик {man_two_gen_str}")
print(f"kженщина {wom_two_gen_str}")


man_two_gen = list(set(list((man_two_gen_str).split(":"))))
wom_two_gen = list(set(list((wom_two_gen_str).split(":"))))
print(f"мужик {man_two_gen}")
print(f"женщина {wom_two_gen}")
...
counted_set_gen = set(counted_gen)
